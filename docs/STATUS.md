...
| Head | `c7a7a36`, working tree clean |
| Tests | **1019 passing**, `flutter analyze` clean |
...
- **The adhan audio is untouched and stays that way** until the user says
  otherwise. No adhan recording has been downloaded or bundled.
